...
class TronApi
{
     ...
     * @return mixed
     */
    function gettrc20transactions($query = [], $address)
    {
        return $this->fullNode->get('v1/accounts/' . $address . '/transactions/trc20', $query);
    }
    ...
    function validatetrc20address($address)
    {
        ...
        $ret = $this->fullNode->post('wallet/validateaddress', $payload);
        return $ret;
    }
