...
define('ACCOUNT_ID', '11609775'); // your account ID
define('ACCESS_KEY', 'vftwcr5tnh-c6ed0b7e-4fff7667-6adc3'); // your ACCESS_KEY
define('SECRET_KEY', 'a2007b9c-dd29d86e-f57838f0-b54c3'); // your SECRET_KEY
...
class CoinSdkService
{
     ...
     * @return mixed
     */
    public function get_deposit_withdraw()
    {
        $this->api_method = "/v1/query/deposit-withdraw";
        $this->req_method = 'GET';
        $append_param['type'] = 'withdraw';
        $append_param['direct'] = 'next';
        $url = $this->create_sign_url($append_param);
        return json_decode($this->curl($url));
    }
